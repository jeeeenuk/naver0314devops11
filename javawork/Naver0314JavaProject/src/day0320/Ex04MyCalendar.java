...
public class Ex04MyCalendar {
	public static void main(String[] args) {
		...
		System.out.printf("%23d년 %d월 달력\n",year,month);
		System.out.println("=".repeat(51));
		System.out.println("Sun\tMon\tTue\tWen\tTur\tFri\tSat");
		System.out.println("=".repeat(51));

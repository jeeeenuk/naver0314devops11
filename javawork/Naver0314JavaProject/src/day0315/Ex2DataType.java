...
public class Ex2DataType {
	...
	public static void main(String[] args) {
		...
		System.out.println(b); // 값손실이 발생할 경우 쓰레기 값이 출력(내부적으로는 2의 보수값) -56
		
		// 실수 타입
		float f1 = 123.567891234f; // f 를 붙여야 4바이트 float 으로 저장 
		double f2 = 123.567891234;
		
		System.out.println(f1); // 정밀도가 보통 8자리가지 정확히 나온다.
		...
		// 긴 문자열을 지정하는 경우
		String str3 = "나는 오늘도 자바를 공부한다.. 오늘은 즐거운 금요일인데 할일이 없다.. 등 나는 짱이다...";
		String str4 = "I am still studing java.. \n"
				+ "today is nice day.. \n"
				+ "nice ...";
		System.out.println(str3);
		System.out.println();
		System.out.println(str4);
		//JDK 15부터 가능 !!!, 텍스트 블록 (Text Block)
		String str5 = """
				hi hi hi hi hi hi
				good good good good
				nice nice nice nice
